...
_Thread_local int gk_cur_jbufs=-1;
_Thread_local jmp_buf gk_jbufs[MAX_JBUFS];
_Thread_local jmp_buf gk_jbuf;

typedef void (*gksighandler_t)(int);

/* These are the holders of the old singal handlers for the trapped signals */
static _Thread_local gksighandler_t old_SIGMEM_handler;  /* Custom signal */
static _Thread_local gksighandler_t old_SIGERR_handler;  /* Custom signal */
static _Thread_local gksighandler_t old_SIGMEM_handlers[MAX_JBUFS];  /* Custom signal */
static _Thread_local gksighandler_t old_SIGERR_handlers[MAX_JBUFS];  /* Custom signal */
